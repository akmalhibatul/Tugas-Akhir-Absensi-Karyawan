    ...
    <div class="container-fluid">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <p>
                    Data Permission <div class="page-title-subheading">Selamat Datang <b><?php echo $nama; ?></b> di Aplikasi Absensi
                </p>
        ...
        <div class="conten">
            ...
            ?>
            <a href="permission.php?kode_karyawan=<?php echo $username; ?>" class="btn btn-primary">Tambah Permission</a>
            <br>
            <hr />
            <?php
            ...
            for ($i = 1; $i <= $bulan; $i++) {
                ...
                $sql = "SELECT * FROM `tb_permission` WHERE `kode_karyawan` = $username AND MONTH(dari) = $i AND YEAR(dari) = $tahun";
