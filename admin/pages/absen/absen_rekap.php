    ...
    <div class="container-fluid">
        ...
        <div class="conten">
            ...
            for ($i = 1; $i <= $bulan; $i++) {
                ...
                $sql = "SELECT * FROM `rekap` WHERE `kode_karyawan` = $kode_karyawan AND MONTH(tanggal) = $i AND YEAR(tanggal) = $tahun";
            ...
            ?>
            <a href="data_absen.php" class="btn btn-warning"><i class="fas fa-arrow-left"></i></a>
        </div>
    </div>
</div>
</div>
